...
import type { AdminPackDetailVO, ResourceType, DurationType } from '@/types/subscription.types'
            ...
            <section className="space-y-4">
              ...
              <div className="grid gap-3">
                <div className="flex items-center justify-between">
                  <span className="text-muted-foreground">扩容包名称</span>
              ...
              <div className="grid gap-3">
                <div className="flex items-center justify-between">
                  ...
                  <Badge variant="outline">
                    {durationTypeLabels[pack.durationType] || pack.durationTypeDesc}
                  </Badge>
                </div>
                {pack.durationType === 'FIXED_DAYS' && pack.durationDays && (
                  <div className="flex items-center justify-between">
                    <span className="text-muted-foreground">有效天数</span>
                    <span>{pack.durationDays}天</span>
                  </div>
                )}
              </div>
            </section>
            ...
            <section className="space-y-4 border-t pt-4">
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="rounded-lg border p-3 text-center">
                  <div className="text-2xl font-bold">{pack.totalAllocations}</div>
                  <div className="text-xs text-muted-foreground">总分配</div>
                </div>
                <div className="rounded-lg border p-3 text-center">
                  <div className="text-2xl font-bold">{pack.totalPurchases}</div>
                  <div className="text-xs text-muted-foreground">购买数</div>
                </div>
                <div className="rounded-lg border p-3 text-center">
                  <div className="text-2xl font-bold">{pack.totalGrants}</div>
